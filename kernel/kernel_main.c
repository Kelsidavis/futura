...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 30u; /* misc: getuid, cred_fields, personality(2), uname_null, rlimits, personality_stored, fcntl(3), prctl(4), getrandom, fadvise64, sched_affinity, copy_file_range, membarrier, statx(2), tgkill, getcpu, readahead, groups, socketpair, open_cloexec, mmap_validation, dev_null_zero, dev_urandom */
