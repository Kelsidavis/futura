...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 837u; /* misc(837): ..., /dev/shm+O_ASYNC (815-819), epoll_fd_fstat (820-822), /proc/self/pagemap (823-826), sysfs_net_lo (827-833), tcp_keepalive+unpriv_port (834-837) */
