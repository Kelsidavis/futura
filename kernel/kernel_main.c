...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1568u; /* misc(1568): ..., tiocoutq (1555-1557), so_rcvlowat (1558-1561), accepted_socket_defaults (1562-1564), seqpacket_msg_eor (1565-1566), dgram_boundaries (1567-1568) */
