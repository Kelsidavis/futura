...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 807u; /* misc(807): ..., RLIMIT_FSIZE enforcement (788-791), O_PATH semantics (792-795), ftruncate/truncate RLIMIT_FSIZE (796-799), inotify poll/epoll/select (800-803), MS_BIND bind mount (804-807) */
