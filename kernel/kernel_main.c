...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1548u; /* misc(1548): ..., af_inet_edge (1523-1530), flock_fcntl_edge (1531-1538), sockname_zero_addrlen (1539-1542), so_linger (1543-1546), socketpair_nonblock (1547-1548) */
