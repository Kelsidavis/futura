...
#define ETC_WRITE(path, content) do { \
    ...
    if (_fd >= 0) { \
        ...
        ETC_WRITE("/etc/motd",
                  ...
                  "\n"
                  "  * 116 built-in commands — type 'help'\n"
