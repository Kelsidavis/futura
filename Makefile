...
ifeq ($(PLATFORM),x86_64)
RUST_LIBS := $(RUST_LIB_VIRTIO_BLK) $(RUST_LIB_VIRTIO_NET) $(RUST_LIB_VIRTIO_INPUT) $(RUST_LIB_NVME) $(RUST_LIB_XHCI) $(RUST_LIB_RTL8111) $(RUST_LIB_HDA) $(RUST_LIB_AMD_SMBUS) $(RUST_LIB_AMD_IOMMU) $(RUST_LIB_AHCI) $(RUST_LIB_HPET) $(RUST_LIB_IGC) $(RUST_LIB_AMD_WDT) $(RUST_LIB_AMD_GPIO) $(RUST_LIB_CMOS_RTC) $(RUST_LIB_AMD_SPI) $(RUST_LIB_TPM_CRB) $(RUST_LIB_AMD_SBTSI) $(RUST_LIB_AMD_PSTATE) $(RUST_LIB_I211) $(RUST_LIB_PCI_MSIX) $(RUST_LIB_USB_HID) $(RUST_LIB_USB_STORAGE) $(RUST_LIB_LAPIC) $(RUST_LIB_UART16550) $(RUST_LIB_I8042) $(RUST_LIB_PCIE_ECAM) $(RUST_LIB_AMD_SMN) $(RUST_LIB_AMD_UMC) $(RUST_LIB_AMD_CCP) $(RUST_LIB_ACPI_PM) $(RUST_LIB_VESA_FB) $(RUST_LIB_PCI_PM) $(RUST_LIB_AMD_DF) $(RUST_LIB_AMD_NBIO) $(RUST_LIB_USB_NET) $(RUST_LIB_USB_HUB) $(RUST_LIB_HDA_REALTEK) $(RUST_LIB_AMD_I2C) $(RUST_LIB_AMD_PSP) $(RUST_LIB_X86_MCE) $(RUST_LIB_PCI_AER) $(RUST_LIB_ACPI_EC) $(RUST_LIB_ETH_PHY) $(RUST_LIB_USB_AUDIO) $(RUST_LIB_ACPI_THERMAL) $(RUST_LIB_DMA_POOL) $(RUST_LIB_FB_CONSOLE) $(RUST_LIB_PCI_SRIOV) $(RUST_LIB_EDID) $(RUST_LIB_AMD_XGBE) $(RUST_LIB_X86_TSC) $(RUST_LIB_AMD_SEV) $(RUST_LIB_VIRTIO_CON) $(RUST_LIB_ACPI_BTN) $(RUST_LIB_AMD_MP2) $(RUST_LIB_X86_CPUID) $(RUST_LIB_INTEL_VTD) $(RUST_LIB_INTEL_HWP) $(RUST_LIB_INTEL_LPSS) $(RUST_LIB_INTEL_PMC) $(RUST_LIB_INTEL_GPIO) $(RUST_LIB_INTEL_WDT) $(RUST_LIB_INTEL_MEI) $(RUST_LIB_INTEL_TBT) $(RUST_LIB_INTEL_THERM) $(RUST_LIB_INTEL_GNA) $(RUST_LIB_INTEL_SST) $(RUST_LIB_INTEL_HDMI) $(RUST_LIB_INTEL_CNVI) $(RUST_LIB_INTEL_DMA) $(RUST_LIB_INTEL_IPU) $(RUST_LIB_INTEL_P2SB) $(RUST_LIB_INTEL_SMBUS) $(RUST_LIB_INTEL_SPI)
else ifeq ($(PLATFORM),arm64)
RUST_LIBS := $(RUST_LIB_VIRTIO_GPU) $(RUST_LIB_VIRTIO_NET) $(RUST_LIB_VIRTIO_BLK) $(RUST_LIB_VIRTIO_INPUT) $(RUST_LIB_APPLE_UART) $(RUST_LIB_APPLE_RTKIT) $(RUST_LIB_APPLE_ANS2) $(RUST_LIB_APPLE_AIC) $(RUST_LIB_APPLE_DART) $(RUST_LIB_APPLE_GPIO) $(RUST_LIB_APPLE_I2C) $(RUST_LIB_APPLE_PCIE) $(RUST_LIB_APPLE_SMC) $(RUST_LIB_APPLE_SPI) $(RUST_LIB_APPLE_MCA)
else
RUST_LIBS :=
endif
