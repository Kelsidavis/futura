...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 40u; /* misc(40): creds, personality, uname, rlimits, fcntl, prctl, getrandom, fadvise, affinity, cfr, membarrier, statx, tgkill, getcpu, readahead, groups, socketpair, cloexec, mmap, devs, caps, perms, dev_full, rlimit_nofile, write_perm, umask, fstat_pipe, setrlimit_hard, dev_null_poll, ioctl_fd_ops */
