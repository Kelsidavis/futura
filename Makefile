...
$(GEN_FEATURE_HDR): FORCE
	...
	{ \
		...
		echo "#define ENABLE_RUST_USERLAND $(if $(filter yes,$(RUST_AVAILABLE)),1,0)"; \
	} > $$tmp; \
	if [ ! -f $@ ] || ! cmp -s $$tmp $@; then mv $$tmp $@; else rm $$tmp; fi
...
RUST_APPLE_DCP_DIR    := $(RUST_ROOT)/apple_dcp
RUST_APPLE_BCM_DIR    := $(RUST_ROOT)/apple_bcm
...
RUST_SDHCI_DIR       := $(RUST_ROOT)/sdhci
RUST_INTEL_PINCTRL_DIR := $(RUST_ROOT)/intel_pinctrl
...
RUST_CROS_EC_DIR     := $(RUST_ROOT)/cros_ec
RUST_ETH_PHY_DIR     := $(RUST_ROOT)/eth_phy
RUST_USB_AUDIO_DIR   := $(RUST_ROOT)/usb_audio
RUST_USB_BT_DIR      := $(RUST_ROOT)/usb_bluetooth
RUST_USB_VIDEO_DIR   := $(RUST_ROOT)/usb_video
RUST_ACPI_BATTERY_DIR := $(RUST_ROOT)/acpi_battery
RUST_ACPI_BACKLIGHT_DIR := $(RUST_ROOT)/acpi_backlight
RUST_IWLWIFI_DIR     := $(RUST_ROOT)/iwlwifi
RUST_RTW89_DIR       := $(RUST_ROOT)/rtw89
...
RUST_AMD_GPU_DIR     := $(RUST_ROOT)/amd_gpu
...
RUST_INTEL_I2C_HID_DIR := $(RUST_ROOT)/intel_i2c_hid
...
RUST_BUILD_DIR_APPLE_DCP   := $(RUST_APPLE_DCP_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
RUST_BUILD_DIR_APPLE_BCM   := $(RUST_APPLE_BCM_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
...
RUST_BUILD_DIR_SDHCI       := $(RUST_SDHCI_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
RUST_BUILD_DIR_INTEL_PINCTRL := $(RUST_INTEL_PINCTRL_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
...
RUST_BUILD_DIR_CROS_EC    := $(RUST_CROS_EC_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
...
RUST_BUILD_DIR_USB_BT     := $(RUST_USB_BT_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
RUST_BUILD_DIR_USB_VIDEO  := $(RUST_USB_VIDEO_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
RUST_BUILD_DIR_ACPI_BATTERY := $(RUST_ACPI_BATTERY_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
RUST_BUILD_DIR_ACPI_BACKLIGHT := $(RUST_ACPI_BACKLIGHT_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
RUST_BUILD_DIR_IWLWIFI      := $(RUST_IWLWIFI_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
RUST_BUILD_DIR_RTW89        := $(RUST_RTW89_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
...
RUST_BUILD_DIR_AMD_GPU    := $(RUST_AMD_GPU_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
...
RUST_BUILD_DIR_INTEL_I2C_HID := $(RUST_INTEL_I2C_HID_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
...
RUST_BUILD_DIR_I915       := $(RUST_I915_DIR)/target/$(RUST_TARGET)/$(RUST_PROFILE)
...
RUST_LIB_APPLE_DCP    := $(RUST_BUILD_DIR_APPLE_DCP)/libapple_dcp.a
RUST_LIB_APPLE_BCM    := $(RUST_BUILD_DIR_APPLE_BCM)/libapple_bcm.a
...
RUST_LIB_SDHCI       := $(RUST_BUILD_DIR_SDHCI)/libsdhci.a
RUST_LIB_INTEL_PINCTRL := $(RUST_BUILD_DIR_INTEL_PINCTRL)/libintel_pinctrl.a
...
RUST_LIB_CROS_EC     := $(RUST_BUILD_DIR_CROS_EC)/libcros_ec.a
RUST_LIB_ETH_PHY     := $(RUST_BUILD_DIR_ETH_PHY)/libeth_phy.a
RUST_LIB_USB_AUDIO   := $(RUST_BUILD_DIR_USB_AUDIO)/libusb_audio.a
RUST_LIB_USB_BT      := $(RUST_BUILD_DIR_USB_BT)/libusb_bluetooth.a
RUST_LIB_USB_VIDEO   := $(RUST_BUILD_DIR_USB_VIDEO)/libusb_video.a
RUST_LIB_ACPI_BATTERY := $(RUST_BUILD_DIR_ACPI_BATTERY)/libacpi_battery.a
RUST_LIB_ACPI_BACKLIGHT := $(RUST_BUILD_DIR_ACPI_BACKLIGHT)/libacpi_backlight.a
RUST_LIB_IWLWIFI      := $(RUST_BUILD_DIR_IWLWIFI)/libiwlwifi.a
RUST_LIB_RTW89        := $(RUST_BUILD_DIR_RTW89)/librtw89.a
...
RUST_LIB_AMD_GPU     := $(RUST_BUILD_DIR_AMD_GPU)/libamd_gpu.a
...
RUST_LIB_INTEL_I2C_HID := $(RUST_BUILD_DIR_INTEL_I2C_HID)/libintel_i2c_hid.a
...
RUST_LIB_I915        := $(RUST_BUILD_DIR_I915)/libi915.a
...
RUST_X86_PLATFORM_LIBS := $(RUST_LIB_X86_CPUID) $(RUST_LIB_X86_TSC) $(RUST_LIB_HPET) $(RUST_LIB_CMOS_RTC) $(RUST_LIB_UART16550) $(RUST_LIB_I8042) $(RUST_LIB_PCIE_ECAM) $(RUST_LIB_PCI_MSIX) $(RUST_LIB_LAPIC) $(RUST_LIB_DMA_POOL) $(RUST_LIB_PCI_PM) $(RUST_LIB_VESA_FB) $(RUST_LIB_FB_CONSOLE) $(RUST_LIB_EDID) $(RUST_LIB_ACPI_PM) $(RUST_LIB_ACPI_EC) $(RUST_LIB_CROS_EC) $(RUST_LIB_ACPI_BTN) $(RUST_LIB_ACPI_THERMAL) $(RUST_LIB_ACPI_BATTERY) $(RUST_LIB_ACPI_BACKLIGHT) $(RUST_LIB_PCI_AER) $(RUST_LIB_PCI_SRIOV) $(RUST_LIB_ETH_PHY) $(RUST_LIB_TPM_CRB) $(RUST_LIB_X86_MCE)

# Storage + USB + Audio (common across vendors)
RUST_X86_STORAGE_LIBS := $(RUST_LIB_NVME) $(RUST_LIB_AHCI) $(RUST_LIB_XHCI) $(RUST_LIB_USB_HID) $(RUST_LIB_USB_STORAGE) $(RUST_LIB_USB_NET) $(RUST_LIB_USB_HUB) $(RUST_LIB_USB_AUDIO) $(RUST_LIB_USB_BT) $(RUST_LIB_USB_VIDEO) $(RUST_LIB_HDA) $(RUST_LIB_HDA_REALTEK) $(RUST_LIB_SDHCI) $(RUST_LIB_INTEL_PINCTRL)

# Network (non-vendor-specific)
RUST_X86_NET_LIBS := $(RUST_LIB_RTL8111) $(RUST_LIB_IGC) $(RUST_LIB_I211) $(RUST_LIB_RTW89)

# AMD chipset drivers
RUST_AMD_LIBS := $(RUST_LIB_AMD_SMBUS) $(RUST_LIB_AMD_IOMMU) $(RUST_LIB_AMD_SMN) $(RUST_LIB_AMD_UMC) $(RUST_LIB_AMD_CCP) $(RUST_LIB_AMD_DF) $(RUST_LIB_AMD_NBIO) $(RUST_LIB_AMD_I2C) $(RUST_LIB_AMD_PSP) $(RUST_LIB_AMD_SEV) $(RUST_LIB_AMD_PSTATE) $(RUST_LIB_AMD_SBTSI) $(RUST_LIB_AMD_GPIO) $(RUST_LIB_AMD_SPI) $(RUST_LIB_AMD_WDT) $(RUST_LIB_AMD_MP2) $(RUST_LIB_AMD_XGBE) $(RUST_LIB_AMD_GPU)

# Intel chipset drivers
RUST_INTEL_LIBS := $(RUST_LIB_INTEL_VTD) $(RUST_LIB_INTEL_HWP) $(RUST_LIB_INTEL_LPSS) $(RUST_LIB_INTEL_I2C_HID) $(RUST_LIB_INTEL_PMC) $(RUST_LIB_INTEL_GPIO) $(RUST_LIB_INTEL_WDT) $(RUST_LIB_INTEL_MEI) $(RUST_LIB_INTEL_TBT) $(RUST_LIB_INTEL_THERM) $(RUST_LIB_INTEL_GNA) $(RUST_LIB_INTEL_SST) $(RUST_LIB_INTEL_HDMI) $(RUST_LIB_INTEL_CNVI) $(RUST_LIB_INTEL_DMA) $(RUST_LIB_INTEL_IPU) $(RUST_LIB_INTEL_P2SB) $(RUST_LIB_INTEL_SMBUS) $(RUST_LIB_INTEL_SPI) $(RUST_LIB_I915) $(RUST_LIB_IWLWIFI)
...
RUST_LIBS := $(RUST_LIB_VIRTIO_GPU) $(RUST_LIB_VIRTIO_NET) $(RUST_LIB_VIRTIO_BLK) $(RUST_LIB_VIRTIO_INPUT) $(RUST_LIB_APPLE_UART) $(RUST_LIB_APPLE_RTKIT) $(RUST_LIB_APPLE_ANS2) $(RUST_LIB_APPLE_AIC) $(RUST_LIB_APPLE_DART) $(RUST_LIB_APPLE_GPIO) $(RUST_LIB_APPLE_I2C) $(RUST_LIB_APPLE_PCIE) $(RUST_LIB_APPLE_SMC) $(RUST_LIB_APPLE_SPI) $(RUST_LIB_APPLE_MCA) $(RUST_LIB_APPLE_HID) $(RUST_LIB_APPLE_XHCI) $(RUST_LIB_APPLE_DCP) $(RUST_LIB_APPLE_BCM) $(RUST_LIB_RPI_AUDIO) $(RUST_LIB_RPI_DISPLAY) $(RUST_LIB_RPI_DMA) $(RUST_LIB_RPI_EMMC) $(RUST_LIB_RPI_GENET) $(RUST_LIB_RPI_GPIO) $(RUST_LIB_RPI_I2C) $(RUST_LIB_RPI_MBOX) $(RUST_LIB_RPI_PCIE) $(RUST_LIB_RPI_PWM) $(RUST_LIB_RPI_RNG) $(RUST_LIB_RPI_SPI) $(RUST_LIB_RPI_THERMAL) $(RUST_LIB_RPI_USB) $(RUST_LIB_RPI_WATCHDOG)
else
RUST_LIBS :=
endif
...
KERNEL_SOURCES := \
    ...
    kernel/tests/apple_gpio_tests.c \
...
WL_SETTINGS_BIN := $(BIN_DIR)/$(PLATFORM)/user/wl-settings
...
RUST_UNAME_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-uname
RUST_UNAME_BLOB := $(OBJ_DIR)/kernel/blobs/rust_uname_blob.o
RUST_PWD_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-pwd
...
RUST_TOUCH_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-touch
...
RUST_TRUE_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-true
RUST_TRUE_BLOB := $(OBJ_DIR)/kernel/blobs/rust_true_blob.o
RUST_FALSE_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-false
RUST_FALSE_BLOB := $(OBJ_DIR)/kernel/blobs/rust_false_blob.o
RUST_ENV_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-env
RUST_ENV_BLOB := $(OBJ_DIR)/kernel/blobs/rust_env_blob.o
RUST_HEAD_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-head
RUST_HEAD_BLOB := $(OBJ_DIR)/kernel/blobs/rust_head_blob.o
RUST_TAIL_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-tail
RUST_TAIL_BLOB := $(OBJ_DIR)/kernel/blobs/rust_tail_blob.o
RUST_GREP_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-grep
...
RUST_TREE_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-tree
RUST_TREE_BLOB := $(OBJ_DIR)/kernel/blobs/rust_tree_blob.o
RUST_WALLPAPER_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-wallpaper
RUST_WALLPAPER_BLOB := $(OBJ_DIR)/kernel/blobs/rust_wallpaper_blob.o
RUST_CP_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-cp
RUST_CP_BLOB := $(OBJ_DIR)/kernel/blobs/rust_cp_blob.o
RUST_MV_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-mv
RUST_MV_BLOB := $(OBJ_DIR)/kernel/blobs/rust_mv_blob.o
RUST_BASENAME_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-basename
...
RUST_WHICH_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-which
RUST_WHICH_BLOB := $(OBJ_DIR)/kernel/blobs/rust_which_blob.o
RUST_READLINK_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-readlink
RUST_READLINK_BLOB := $(OBJ_DIR)/kernel/blobs/rust_readlink_blob.o
RUST_LN_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-ln
RUST_LN_BLOB := $(OBJ_DIR)/kernel/blobs/rust_ln_blob.o
RUST_TEE_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-tee
RUST_TEE_BLOB := $(OBJ_DIR)/kernel/blobs/rust_tee_blob.o
RUST_YES_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-yes
RUST_YES_BLOB := $(OBJ_DIR)/kernel/blobs/rust_yes_blob.o
RUST_UNIQ_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-uniq
RUST_UNIQ_BLOB := $(OBJ_DIR)/kernel/blobs/rust_uniq_blob.o
RUST_REALPATH_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-realpath
RUST_REALPATH_BLOB := $(OBJ_DIR)/kernel/blobs/rust_realpath_blob.o
RUST_CMP_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-cmp
RUST_CMP_BLOB := $(OBJ_DIR)/kernel/blobs/rust_cmp_blob.o
RUST_NL_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-nl
RUST_NL_BLOB := $(OBJ_DIR)/kernel/blobs/rust_nl_blob.o
RUST_REV_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-rev
RUST_REV_BLOB := $(OBJ_DIR)/kernel/blobs/rust_rev_blob.o
RUST_OD_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-od
RUST_OD_BLOB := $(OBJ_DIR)/kernel/blobs/rust_od_blob.o
RUST_PRINTENV_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-printenv
RUST_PRINTENV_BLOB := $(OBJ_DIR)/kernel/blobs/rust_printenv_blob.o
RUST_WHOAMI_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-whoami
RUST_WHOAMI_BLOB := $(OBJ_DIR)/kernel/blobs/rust_whoami_blob.o
RUST_ID_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-id
RUST_ID_BLOB := $(OBJ_DIR)/kernel/blobs/rust_id_blob.o
RUST_CHMOD_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-chmod
RUST_CHMOD_BLOB := $(OBJ_DIR)/kernel/blobs/rust_chmod_blob.o
RUST_HOSTNAME_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-hostname
RUST_HOSTNAME_BLOB := $(OBJ_DIR)/kernel/blobs/rust_hostname_blob.o
RUST_ARCH_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-arch
RUST_ARCH_BLOB := $(OBJ_DIR)/kernel/blobs/rust_arch_blob.o
RUST_KILL_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-kill
RUST_KILL_BLOB := $(OBJ_DIR)/kernel/blobs/rust_kill_blob.o
RUST_RMDIR_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-rmdir
RUST_RMDIR_BLOB := $(OBJ_DIR)/kernel/blobs/rust_rmdir_blob.o
RUST_SYNC_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-sync
RUST_SYNC_BLOB := $(OBJ_DIR)/kernel/blobs/rust_sync_blob.o
RUST_FOLD_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-fold
RUST_FOLD_BLOB := $(OBJ_DIR)/kernel/blobs/rust_fold_blob.o
RUST_TAC_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-tac
RUST_TAC_BLOB := $(OBJ_DIR)/kernel/blobs/rust_tac_blob.o
RUST_STRINGS_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-strings
RUST_STRINGS_BLOB := $(OBJ_DIR)/kernel/blobs/rust_strings_blob.o
RUST_CUT_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-cut
RUST_CUT_BLOB := $(OBJ_DIR)/kernel/blobs/rust_cut_blob.o
RUST_SEQ_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-seq
RUST_SEQ_BLOB := $(OBJ_DIR)/kernel/blobs/rust_seq_blob.o
RUST_TR_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-tr
RUST_TR_BLOB := $(OBJ_DIR)/kernel/blobs/rust_tr_blob.o
RUST_BASE64_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-base64
RUST_BASE64_BLOB := $(OBJ_DIR)/kernel/blobs/rust_base64_blob.o
RUST_MKTEMP_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-mktemp
RUST_MKTEMP_BLOB := $(OBJ_DIR)/kernel/blobs/rust_mktemp_blob.o
RUST_UPTIME_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-uptime
RUST_UPTIME_BLOB := $(OBJ_DIR)/kernel/blobs/rust_uptime_blob.o
RUST_TRUNCATE_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-truncate
RUST_TRUNCATE_BLOB := $(OBJ_DIR)/kernel/blobs/rust_truncate_blob.o
RUST_STAT_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-stat
RUST_STAT_BLOB := $(OBJ_DIR)/kernel/blobs/rust_stat_blob.o
RUST_TTY_BIN := $(BIN_DIR)/$(PLATFORM)/user/rust-tty
RUST_TTY_BLOB := $(OBJ_DIR)/kernel/blobs/rust_tty_blob.o
...
ARM64_WL_SETTINGS_BIN         := $(BIN_DIR)/arm64/user/wl-settings
...
ARM64_RUST_UNAME_BIN          := $(BIN_DIR)/arm64/user/rust-uname
ARM64_RUST_UNAME_BLOB         := $(OBJ_DIR)/kernel/blobs/arm64_rust_uname_blob.o
ARM64_RUST_PWD_BIN            := $(BIN_DIR)/arm64/user/rust-pwd
...
ARM64_RUST_TOUCH_BIN          := $(BIN_DIR)/arm64/user/rust-touch
...
ARM64_RUST_TRUE_BIN           := $(BIN_DIR)/arm64/user/rust-true
ARM64_RUST_TRUE_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_true_blob.o
ARM64_RUST_FALSE_BIN          := $(BIN_DIR)/arm64/user/rust-false
ARM64_RUST_FALSE_BLOB         := $(OBJ_DIR)/kernel/blobs/arm64_rust_false_blob.o
ARM64_RUST_ENV_BIN            := $(BIN_DIR)/arm64/user/rust-env
ARM64_RUST_ENV_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_env_blob.o
ARM64_RUST_HEAD_BIN           := $(BIN_DIR)/arm64/user/rust-head
ARM64_RUST_HEAD_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_head_blob.o
ARM64_RUST_TAIL_BIN           := $(BIN_DIR)/arm64/user/rust-tail
ARM64_RUST_TAIL_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_tail_blob.o
ARM64_RUST_GREP_BIN           := $(BIN_DIR)/arm64/user/rust-grep
...
ARM64_RUST_TREE_BIN           := $(BIN_DIR)/arm64/user/rust-tree
ARM64_RUST_TREE_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_tree_blob.o
ARM64_RUST_WALLPAPER_BIN      := $(BIN_DIR)/arm64/user/rust-wallpaper
ARM64_RUST_WALLPAPER_BLOB     := $(OBJ_DIR)/kernel/blobs/arm64_rust_wallpaper_blob.o
ARM64_RUST_CP_BIN             := $(BIN_DIR)/arm64/user/rust-cp
ARM64_RUST_CP_BLOB            := $(OBJ_DIR)/kernel/blobs/arm64_rust_cp_blob.o
ARM64_RUST_MV_BIN             := $(BIN_DIR)/arm64/user/rust-mv
ARM64_RUST_MV_BLOB            := $(OBJ_DIR)/kernel/blobs/arm64_rust_mv_blob.o
ARM64_RUST_BASENAME_BIN       := $(BIN_DIR)/arm64/user/rust-basename
...
ARM64_RUST_WHICH_BIN          := $(BIN_DIR)/arm64/user/rust-which
ARM64_RUST_WHICH_BLOB         := $(OBJ_DIR)/kernel/blobs/arm64_rust_which_blob.o
ARM64_RUST_READLINK_BIN       := $(BIN_DIR)/arm64/user/rust-readlink
ARM64_RUST_READLINK_BLOB      := $(OBJ_DIR)/kernel/blobs/arm64_rust_readlink_blob.o
ARM64_RUST_LN_BIN             := $(BIN_DIR)/arm64/user/rust-ln
ARM64_RUST_LN_BLOB            := $(OBJ_DIR)/kernel/blobs/arm64_rust_ln_blob.o
ARM64_RUST_TEE_BIN            := $(BIN_DIR)/arm64/user/rust-tee
ARM64_RUST_TEE_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_tee_blob.o
ARM64_RUST_YES_BIN            := $(BIN_DIR)/arm64/user/rust-yes
ARM64_RUST_YES_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_yes_blob.o
ARM64_RUST_UNIQ_BIN           := $(BIN_DIR)/arm64/user/rust-uniq
ARM64_RUST_UNIQ_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_uniq_blob.o
ARM64_RUST_REALPATH_BIN       := $(BIN_DIR)/arm64/user/rust-realpath
ARM64_RUST_REALPATH_BLOB      := $(OBJ_DIR)/kernel/blobs/arm64_rust_realpath_blob.o
ARM64_RUST_CMP_BIN            := $(BIN_DIR)/arm64/user/rust-cmp
ARM64_RUST_CMP_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_cmp_blob.o
ARM64_RUST_NL_BIN             := $(BIN_DIR)/arm64/user/rust-nl
ARM64_RUST_NL_BLOB            := $(OBJ_DIR)/kernel/blobs/arm64_rust_nl_blob.o
ARM64_RUST_REV_BIN            := $(BIN_DIR)/arm64/user/rust-rev
ARM64_RUST_REV_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_rev_blob.o
ARM64_RUST_OD_BIN             := $(BIN_DIR)/arm64/user/rust-od
ARM64_RUST_OD_BLOB            := $(OBJ_DIR)/kernel/blobs/arm64_rust_od_blob.o
ARM64_RUST_PRINTENV_BIN       := $(BIN_DIR)/arm64/user/rust-printenv
ARM64_RUST_PRINTENV_BLOB      := $(OBJ_DIR)/kernel/blobs/arm64_rust_printenv_blob.o
ARM64_RUST_WHOAMI_BIN         := $(BIN_DIR)/arm64/user/rust-whoami
ARM64_RUST_WHOAMI_BLOB        := $(OBJ_DIR)/kernel/blobs/arm64_rust_whoami_blob.o
ARM64_RUST_ID_BIN             := $(BIN_DIR)/arm64/user/rust-id
ARM64_RUST_ID_BLOB            := $(OBJ_DIR)/kernel/blobs/arm64_rust_id_blob.o
ARM64_RUST_CHMOD_BIN          := $(BIN_DIR)/arm64/user/rust-chmod
ARM64_RUST_CHMOD_BLOB         := $(OBJ_DIR)/kernel/blobs/arm64_rust_chmod_blob.o
ARM64_RUST_HOSTNAME_BIN       := $(BIN_DIR)/arm64/user/rust-hostname
ARM64_RUST_HOSTNAME_BLOB      := $(OBJ_DIR)/kernel/blobs/arm64_rust_hostname_blob.o
ARM64_RUST_ARCH_BIN           := $(BIN_DIR)/arm64/user/rust-arch
ARM64_RUST_ARCH_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_arch_blob.o
ARM64_RUST_KILL_BIN           := $(BIN_DIR)/arm64/user/rust-kill
ARM64_RUST_KILL_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_kill_blob.o
ARM64_RUST_RMDIR_BIN          := $(BIN_DIR)/arm64/user/rust-rmdir
ARM64_RUST_RMDIR_BLOB         := $(OBJ_DIR)/kernel/blobs/arm64_rust_rmdir_blob.o
ARM64_RUST_SYNC_BIN           := $(BIN_DIR)/arm64/user/rust-sync
ARM64_RUST_SYNC_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_sync_blob.o
ARM64_RUST_FOLD_BIN           := $(BIN_DIR)/arm64/user/rust-fold
ARM64_RUST_FOLD_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_fold_blob.o
ARM64_RUST_TAC_BIN            := $(BIN_DIR)/arm64/user/rust-tac
ARM64_RUST_TAC_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_tac_blob.o
ARM64_RUST_STRINGS_BIN        := $(BIN_DIR)/arm64/user/rust-strings
ARM64_RUST_STRINGS_BLOB       := $(OBJ_DIR)/kernel/blobs/arm64_rust_strings_blob.o
ARM64_RUST_CUT_BIN            := $(BIN_DIR)/arm64/user/rust-cut
ARM64_RUST_CUT_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_cut_blob.o
ARM64_RUST_SEQ_BIN            := $(BIN_DIR)/arm64/user/rust-seq
ARM64_RUST_SEQ_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_seq_blob.o
ARM64_RUST_TR_BIN             := $(BIN_DIR)/arm64/user/rust-tr
ARM64_RUST_TR_BLOB            := $(OBJ_DIR)/kernel/blobs/arm64_rust_tr_blob.o
ARM64_RUST_BASE64_BIN         := $(BIN_DIR)/arm64/user/rust-base64
ARM64_RUST_BASE64_BLOB        := $(OBJ_DIR)/kernel/blobs/arm64_rust_base64_blob.o
ARM64_RUST_MKTEMP_BIN         := $(BIN_DIR)/arm64/user/rust-mktemp
ARM64_RUST_MKTEMP_BLOB        := $(OBJ_DIR)/kernel/blobs/arm64_rust_mktemp_blob.o
ARM64_RUST_UPTIME_BIN         := $(BIN_DIR)/arm64/user/rust-uptime
ARM64_RUST_UPTIME_BLOB        := $(OBJ_DIR)/kernel/blobs/arm64_rust_uptime_blob.o
ARM64_RUST_TRUNCATE_BIN       := $(BIN_DIR)/arm64/user/rust-truncate
ARM64_RUST_TRUNCATE_BLOB      := $(OBJ_DIR)/kernel/blobs/arm64_rust_truncate_blob.o
ARM64_RUST_STAT_BIN           := $(BIN_DIR)/arm64/user/rust-stat
ARM64_RUST_STAT_BLOB          := $(OBJ_DIR)/kernel/blobs/arm64_rust_stat_blob.o
ARM64_RUST_TTY_BIN            := $(BIN_DIR)/arm64/user/rust-tty
ARM64_RUST_TTY_BLOB           := $(OBJ_DIR)/kernel/blobs/arm64_rust_tty_blob.o
...
# Rust user-space CLIs — independent of Wayland, gated only on a
# working Rust toolchain so CI hosts without rustup don't break.
ifeq ($(RUST_AVAILABLE),yes)
ifneq ($(shell uname -s),Darwin)
OBJECTS += $(RUST_HELLO_BLOB) $(RUST_UNAME_BLOB) $(RUST_PWD_BLOB) $(RUST_LS_BLOB) $(RUST_MKDIR_BLOB) $(RUST_TOUCH_BLOB) $(RUST_RM_BLOB) $(RUST_CAT_BLOB) $(RUST_WC_BLOB) $(RUST_TRUE_BLOB) $(RUST_FALSE_BLOB) $(RUST_ENV_BLOB) $(RUST_HEAD_BLOB) $(RUST_TAIL_BLOB) $(RUST_GREP_BLOB) $(RUST_SLEEP_BLOB) $(RUST_DATE_BLOB) $(RUST_SETTINGS_BLOB) $(RUST_TREE_BLOB) $(RUST_WALLPAPER_BLOB) $(RUST_CP_BLOB) $(RUST_MV_BLOB) $(RUST_BASENAME_BLOB) $(RUST_DIRNAME_BLOB) $(RUST_CLEAR_BLOB) $(RUST_WHICH_BLOB) $(RUST_READLINK_BLOB) $(RUST_LN_BLOB) $(RUST_TEE_BLOB) $(RUST_YES_BLOB) $(RUST_UNIQ_BLOB) $(RUST_REALPATH_BLOB) $(RUST_CMP_BLOB) $(RUST_NL_BLOB) $(RUST_REV_BLOB) $(RUST_OD_BLOB) $(RUST_PRINTENV_BLOB) $(RUST_WHOAMI_BLOB) $(RUST_ID_BLOB) $(RUST_CHMOD_BLOB) $(RUST_HOSTNAME_BLOB) $(RUST_ARCH_BLOB) $(RUST_KILL_BLOB) $(RUST_RMDIR_BLOB) $(RUST_SYNC_BLOB) $(RUST_FOLD_BLOB) $(RUST_TAC_BLOB) $(RUST_STRINGS_BLOB) $(RUST_CUT_BLOB) $(RUST_SEQ_BLOB) $(RUST_TR_BLOB) $(RUST_BASE64_BLOB) $(RUST_MKTEMP_BLOB) $(RUST_UPTIME_BLOB) $(RUST_TRUNCATE_BLOB) $(RUST_STAT_BLOB) $(RUST_TTY_BLOB)
endif
endif
else ifeq ($(PLATFORM),arm64)
...
ifeq ($(RUST_AVAILABLE),yes)
OBJECTS += $(ARM64_RUST_HELLO_BLOB) $(ARM64_RUST_UNAME_BLOB) $(ARM64_RUST_PWD_BLOB) $(ARM64_RUST_LS_BLOB) $(ARM64_RUST_MKDIR_BLOB) $(ARM64_RUST_TOUCH_BLOB) $(ARM64_RUST_RM_BLOB) $(ARM64_RUST_CAT_BLOB) $(ARM64_RUST_WC_BLOB) $(ARM64_RUST_TRUE_BLOB) $(ARM64_RUST_FALSE_BLOB) $(ARM64_RUST_ENV_BLOB) $(ARM64_RUST_HEAD_BLOB) $(ARM64_RUST_TAIL_BLOB) $(ARM64_RUST_GREP_BLOB) $(ARM64_RUST_SLEEP_BLOB) $(ARM64_RUST_DATE_BLOB) $(ARM64_RUST_SETTINGS_BLOB) $(ARM64_RUST_TREE_BLOB) $(ARM64_RUST_WALLPAPER_BLOB) $(ARM64_RUST_CP_BLOB) $(ARM64_RUST_MV_BLOB) $(ARM64_RUST_BASENAME_BLOB) $(ARM64_RUST_DIRNAME_BLOB) $(ARM64_RUST_CLEAR_BLOB) $(ARM64_RUST_WHICH_BLOB) $(ARM64_RUST_READLINK_BLOB) $(ARM64_RUST_LN_BLOB) $(ARM64_RUST_TEE_BLOB) $(ARM64_RUST_YES_BLOB) $(ARM64_RUST_UNIQ_BLOB) $(ARM64_RUST_REALPATH_BLOB) $(ARM64_RUST_CMP_BLOB) $(ARM64_RUST_NL_BLOB) $(ARM64_RUST_REV_BLOB) $(ARM64_RUST_OD_BLOB) $(ARM64_RUST_PRINTENV_BLOB) $(ARM64_RUST_WHOAMI_BLOB) $(ARM64_RUST_ID_BLOB) $(ARM64_RUST_CHMOD_BLOB) $(ARM64_RUST_HOSTNAME_BLOB) $(ARM64_RUST_ARCH_BLOB) $(ARM64_RUST_KILL_BLOB) $(ARM64_RUST_RMDIR_BLOB) $(ARM64_RUST_SYNC_BLOB) $(ARM64_RUST_FOLD_BLOB) $(ARM64_RUST_TAC_BLOB) $(ARM64_RUST_STRINGS_BLOB) $(ARM64_RUST_CUT_BLOB) $(ARM64_RUST_SEQ_BLOB) $(ARM64_RUST_TR_BLOB) $(ARM64_RUST_BASE64_BLOB) $(ARM64_RUST_MKTEMP_BLOB) $(ARM64_RUST_UPTIME_BLOB) $(ARM64_RUST_TRUNCATE_BLOB) $(ARM64_RUST_STAT_BLOB) $(ARM64_RUST_TTY_BLOB)
endif
endif
...
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_SDHCI),sdhci,$(RUST_SDHCI_DIR)))
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_INTEL_PINCTRL),intel_pinctrl,$(RUST_INTEL_PINCTRL_DIR)))
...
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_CROS_EC),cros_ec,$(RUST_CROS_EC_DIR)))
...
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_USB_BT),usb_bluetooth,$(RUST_USB_BT_DIR)))
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_USB_VIDEO),usb_video,$(RUST_USB_VIDEO_DIR)))
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_ACPI_THERMAL),acpi_thermal,$(RUST_ACPI_THERMAL_DIR)))
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_ACPI_BATTERY),acpi_battery,$(RUST_ACPI_BATTERY_DIR)))
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_ACPI_BACKLIGHT),acpi_backlight,$(RUST_ACPI_BACKLIGHT_DIR)))
...
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_AMD_GPU),amd_gpu,$(RUST_AMD_GPU_DIR)))
...
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_INTEL_I2C_HID),intel_i2c_hid,$(RUST_INTEL_I2C_HID_DIR)))
...
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_I915),i915,$(RUST_I915_DIR)))
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_IWLWIFI),iwlwifi,$(RUST_IWLWIFI_DIR)))
$(eval $(call RUST_DRIVER_RULE,$(RUST_LIB_RTW89),rtw89,$(RUST_RTW89_DIR)))
...
$(RUST_LIB_APPLE_HID): $(RUST_SOURCES)
	@$(RUSTC) --print target-list | grep -q $(RUST_TARGET) >/dev/null || { \
		echo "error: rust target '$(RUST_TARGET)' not installed for $(RUSTC)." >&2; exit 1; }
	@echo "CARGO apple_hid ($(RUST_PROFILE))"
...
$(RUST_LIB_APPLE_DCP): $(RUST_SOURCES)
	@$(RUSTC) --print target-list | grep -q $(RUST_TARGET) >/dev/null || { \
		echo "error: rust target '$(RUST_TARGET)' not installed for $(RUSTC)." >&2; exit 1; }
	@echo "CARGO apple_dcp ($(RUST_PROFILE))"
	@cd $(RUST_APPLE_DCP_DIR) && RUSTFLAGS="-C panic=abort -C force-unwind-tables=no $(RUSTFLAGS)" $(CARGO) build --release --target $(RUST_TARGET)
	@tmpdir=$$(mktemp -d); \
	cd $$tmpdir && $(AR) x $(abspath $(RUST_LIB_APPLE_DCP)) && for obj in *.o; do $(OBJCOPY) --remove-section='.gcc_except_table*' --remove-section='.eh_frame*' $$obj >/dev/null 2>&1 || true; done && $(AR) rcs $(abspath $(RUST_LIB_APPLE_DCP)) *.o; \
	rm -rf $$tmpdir

$(RUST_LIB_APPLE_BCM): $(RUST_SOURCES)
	@$(RUSTC) --print target-list | grep -q $(RUST_TARGET) >/dev/null || { \
		echo "error: rust target '$(RUST_TARGET)' not installed for $(RUSTC)." >&2; exit 1; }
	@echo "CARGO apple_bcm ($(RUST_PROFILE))"
	@cd $(RUST_APPLE_BCM_DIR) && RUSTFLAGS="-C panic=abort -C force-unwind-tables=no $(RUSTFLAGS)" $(CARGO) build --release --target $(RUST_TARGET)
	@tmpdir=$$(mktemp -d); \
	cd $$tmpdir && $(AR) x $(abspath $(RUST_LIB_APPLE_BCM)) && for obj in *.o; do $(OBJCOPY) --remove-section='.gcc_except_table*' --remove-section='.eh_frame*' $$obj >/dev/null 2>&1 || true; done && $(AR) rcs $(abspath $(RUST_LIB_APPLE_BCM)) *.o; \
	rm -rf $$tmpdir
...
# rust-uname (Rust user-space CLI) — same gating pattern as rust-hello.
ifneq ($(PLATFORM),arm64)
$(RUST_UNAME_BIN):
	@echo "Building $(PLATFORM) rust-uname..."
	@$(MAKE) -C src/user/rust-uname PLATFORM=$(PLATFORM) all
endif

$(RUST_UNAME_BLOB): $(RUST_UNAME_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

# rust-pwd (Rust user-space CLI) — same gating pattern as rust-hello.
ifneq ($(PLATFORM),arm64)
$(RUST_PWD_BIN):
	@echo "Building $(PLATFORM) rust-pwd..."
	@$(MAKE) -C src/user/rust-pwd PLATFORM=$(PLATFORM) all
endif

$(RUST_PWD_BLOB): $(RUST_PWD_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

# rust-ls (Rust user-space CLI) — same gating pattern as rust-hello.
ifneq ($(PLATFORM),arm64)
$(RUST_LS_BIN):
	@echo "Building $(PLATFORM) rust-ls..."
	@$(MAKE) -C src/user/rust-ls PLATFORM=$(PLATFORM) all
endif

$(RUST_LS_BLOB): $(RUST_LS_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
# rust-touch (Rust user-space CLI) — same gating pattern as rust-hello.
ifneq ($(PLATFORM),arm64)
$(RUST_TOUCH_BIN):
	@echo "Building $(PLATFORM) rust-touch..."
	@$(MAKE) -C src/user/rust-touch PLATFORM=$(PLATFORM) all
endif

$(RUST_TOUCH_BLOB): $(RUST_TOUCH_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

# rust-rm (Rust user-space CLI) — same gating pattern as rust-hello.
ifneq ($(PLATFORM),arm64)
$(RUST_RM_BIN):
	@echo "Building $(PLATFORM) rust-rm..."
	@$(MAKE) -C src/user/rust-rm PLATFORM=$(PLATFORM) all
endif

$(RUST_RM_BLOB): $(RUST_RM_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
# rust-true / rust-false — the simplest possible exit-status utilities.
ifneq ($(PLATFORM),arm64)
$(RUST_TRUE_BIN):
	@echo "Building $(PLATFORM) rust-true..."
	@$(MAKE) -C src/user/rust-true PLATFORM=$(PLATFORM) all
$(RUST_FALSE_BIN):
	@echo "Building $(PLATFORM) rust-false..."
	@$(MAKE) -C src/user/rust-false PLATFORM=$(PLATFORM) all
$(RUST_ENV_BIN):
	@echo "Building $(PLATFORM) rust-env..."
	@$(MAKE) -C src/user/rust-env PLATFORM=$(PLATFORM) all
$(RUST_HEAD_BIN):
	@echo "Building $(PLATFORM) rust-head..."
	@$(MAKE) -C src/user/rust-head PLATFORM=$(PLATFORM) all
$(RUST_TAIL_BIN):
	@echo "Building $(PLATFORM) rust-tail..."
	@$(MAKE) -C src/user/rust-tail PLATFORM=$(PLATFORM) all
$(RUST_GREP_BIN):
	@echo "Building $(PLATFORM) rust-grep..."
	@$(MAKE) -C src/user/rust-grep PLATFORM=$(PLATFORM) all
$(RUST_SLEEP_BIN):
...
$(RUST_TREE_BIN):
	@echo "Building $(PLATFORM) rust-tree..."
	@$(MAKE) -C src/user/rust-tree PLATFORM=$(PLATFORM) all
$(RUST_WALLPAPER_BIN):
	@echo "Building $(PLATFORM) rust-wallpaper..."
	@$(MAKE) -C src/user/rust-wallpaper PLATFORM=$(PLATFORM) all
$(RUST_CP_BIN):
	@echo "Building $(PLATFORM) rust-cp..."
	@$(MAKE) -C src/user/rust-cp PLATFORM=$(PLATFORM) all
$(RUST_MV_BIN):
	@echo "Building $(PLATFORM) rust-mv..."
	@$(MAKE) -C src/user/rust-mv PLATFORM=$(PLATFORM) all
$(RUST_BASENAME_BIN):
	@echo "Building $(PLATFORM) rust-basename..."
	@$(MAKE) -C src/user/rust-basename PLATFORM=$(PLATFORM) all
$(RUST_DIRNAME_BIN):
...
$(RUST_WHICH_BIN):
	@echo "Building $(PLATFORM) rust-which..."
	@$(MAKE) -C src/user/rust-which PLATFORM=$(PLATFORM) all
$(RUST_READLINK_BIN):
	@echo "Building $(PLATFORM) rust-readlink..."
	@$(MAKE) -C src/user/rust-readlink PLATFORM=$(PLATFORM) all
$(RUST_LN_BIN):
	@echo "Building $(PLATFORM) rust-ln..."
	@$(MAKE) -C src/user/rust-ln PLATFORM=$(PLATFORM) all
$(RUST_TEE_BIN):
	@echo "Building $(PLATFORM) rust-tee..."
	@$(MAKE) -C src/user/rust-tee PLATFORM=$(PLATFORM) all
$(RUST_YES_BIN):
	@echo "Building $(PLATFORM) rust-yes..."
	@$(MAKE) -C src/user/rust-yes PLATFORM=$(PLATFORM) all
$(RUST_UNIQ_BIN):
	@echo "Building $(PLATFORM) rust-uniq..."
	@$(MAKE) -C src/user/rust-uniq PLATFORM=$(PLATFORM) all
$(RUST_REALPATH_BIN):
	@echo "Building $(PLATFORM) rust-realpath..."
	@$(MAKE) -C src/user/rust-realpath PLATFORM=$(PLATFORM) all
$(RUST_CMP_BIN):
	@echo "Building $(PLATFORM) rust-cmp..."
	@$(MAKE) -C src/user/rust-cmp PLATFORM=$(PLATFORM) all
$(RUST_NL_BIN):
	@echo "Building $(PLATFORM) rust-nl..."
	@$(MAKE) -C src/user/rust-nl PLATFORM=$(PLATFORM) all
$(RUST_REV_BIN):
	@echo "Building $(PLATFORM) rust-rev..."
	@$(MAKE) -C src/user/rust-rev PLATFORM=$(PLATFORM) all
$(RUST_OD_BIN):
	@echo "Building $(PLATFORM) rust-od..."
	@$(MAKE) -C src/user/rust-od PLATFORM=$(PLATFORM) all
$(RUST_PRINTENV_BIN):
	@echo "Building $(PLATFORM) rust-printenv..."
	@$(MAKE) -C src/user/rust-printenv PLATFORM=$(PLATFORM) all
$(RUST_WHOAMI_BIN):
	@echo "Building $(PLATFORM) rust-whoami..."
	@$(MAKE) -C src/user/rust-whoami PLATFORM=$(PLATFORM) all
$(RUST_ID_BIN):
	@echo "Building $(PLATFORM) rust-id..."
	@$(MAKE) -C src/user/rust-id PLATFORM=$(PLATFORM) all
$(RUST_CHMOD_BIN):
	@echo "Building $(PLATFORM) rust-chmod..."
	@$(MAKE) -C src/user/rust-chmod PLATFORM=$(PLATFORM) all
$(RUST_HOSTNAME_BIN):
	@echo "Building $(PLATFORM) rust-hostname..."
	@$(MAKE) -C src/user/rust-hostname PLATFORM=$(PLATFORM) all
$(RUST_ARCH_BIN):
	@echo "Building $(PLATFORM) rust-arch..."
	@$(MAKE) -C src/user/rust-arch PLATFORM=$(PLATFORM) all
$(RUST_KILL_BIN):
	@echo "Building $(PLATFORM) rust-kill..."
	@$(MAKE) -C src/user/rust-kill PLATFORM=$(PLATFORM) all
$(RUST_RMDIR_BIN):
	@echo "Building $(PLATFORM) rust-rmdir..."
	@$(MAKE) -C src/user/rust-rmdir PLATFORM=$(PLATFORM) all
$(RUST_SYNC_BIN):
	@echo "Building $(PLATFORM) rust-sync..."
	@$(MAKE) -C src/user/rust-sync PLATFORM=$(PLATFORM) all
$(RUST_FOLD_BIN):
	@echo "Building $(PLATFORM) rust-fold..."
	@$(MAKE) -C src/user/rust-fold PLATFORM=$(PLATFORM) all
$(RUST_TAC_BIN):
	@echo "Building $(PLATFORM) rust-tac..."
	@$(MAKE) -C src/user/rust-tac PLATFORM=$(PLATFORM) all
$(RUST_STRINGS_BIN):
	@echo "Building $(PLATFORM) rust-strings..."
	@$(MAKE) -C src/user/rust-strings PLATFORM=$(PLATFORM) all
$(RUST_CUT_BIN):
	@echo "Building $(PLATFORM) rust-cut..."
	@$(MAKE) -C src/user/rust-cut PLATFORM=$(PLATFORM) all
$(RUST_SEQ_BIN):
	@echo "Building $(PLATFORM) rust-seq..."
	@$(MAKE) -C src/user/rust-seq PLATFORM=$(PLATFORM) all
$(RUST_TR_BIN):
	@echo "Building $(PLATFORM) rust-tr..."
	@$(MAKE) -C src/user/rust-tr PLATFORM=$(PLATFORM) all
$(RUST_BASE64_BIN):
	@echo "Building $(PLATFORM) rust-base64..."
	@$(MAKE) -C src/user/rust-base64 PLATFORM=$(PLATFORM) all
$(RUST_MKTEMP_BIN):
	@echo "Building $(PLATFORM) rust-mktemp..."
	@$(MAKE) -C src/user/rust-mktemp PLATFORM=$(PLATFORM) all
$(RUST_UPTIME_BIN):
	@echo "Building $(PLATFORM) rust-uptime..."
	@$(MAKE) -C src/user/rust-uptime PLATFORM=$(PLATFORM) all
$(RUST_TRUNCATE_BIN):
	@echo "Building $(PLATFORM) rust-truncate..."
	@$(MAKE) -C src/user/rust-truncate PLATFORM=$(PLATFORM) all
$(RUST_STAT_BIN):
	@echo "Building $(PLATFORM) rust-stat..."
	@$(MAKE) -C src/user/rust-stat PLATFORM=$(PLATFORM) all
$(RUST_TTY_BIN):
	@echo "Building $(PLATFORM) rust-tty..."
	@$(MAKE) -C src/user/rust-tty PLATFORM=$(PLATFORM) all
endif

$(RUST_TRUE_BLOB): $(RUST_TRUE_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
$(RUST_FALSE_BLOB): $(RUST_FALSE_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
$(RUST_ENV_BLOB): $(RUST_ENV_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_HEAD_BLOB): $(RUST_HEAD_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_TAIL_BLOB): $(RUST_TAIL_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_GREP_BLOB): $(RUST_GREP_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
$(RUST_TREE_BLOB): $(RUST_TREE_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_WALLPAPER_BLOB): $(RUST_WALLPAPER_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_CP_BLOB): $(RUST_CP_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_MV_BLOB): $(RUST_MV_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_BASENAME_BLOB): $(RUST_BASENAME_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
$(RUST_WHICH_BLOB): $(RUST_WHICH_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_READLINK_BLOB): $(RUST_READLINK_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_LN_BLOB): $(RUST_LN_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_TEE_BLOB): $(RUST_TEE_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_YES_BLOB): $(RUST_YES_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_UNIQ_BLOB): $(RUST_UNIQ_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_REALPATH_BLOB): $(RUST_REALPATH_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_CMP_BLOB): $(RUST_CMP_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_NL_BLOB): $(RUST_NL_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_REV_BLOB): $(RUST_REV_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_OD_BLOB): $(RUST_OD_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_PRINTENV_BLOB): $(RUST_PRINTENV_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_WHOAMI_BLOB): $(RUST_WHOAMI_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_ID_BLOB): $(RUST_ID_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_CHMOD_BLOB): $(RUST_CHMOD_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_HOSTNAME_BLOB): $(RUST_HOSTNAME_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_ARCH_BLOB): $(RUST_ARCH_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_KILL_BLOB): $(RUST_KILL_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_RMDIR_BLOB): $(RUST_RMDIR_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_SYNC_BLOB): $(RUST_SYNC_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_FOLD_BLOB): $(RUST_FOLD_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_TAC_BLOB): $(RUST_TAC_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_STRINGS_BLOB): $(RUST_STRINGS_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_CUT_BLOB): $(RUST_CUT_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_SEQ_BLOB): $(RUST_SEQ_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_TR_BLOB): $(RUST_TR_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_BASE64_BLOB): $(RUST_BASE64_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_MKTEMP_BLOB): $(RUST_MKTEMP_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_UPTIME_BLOB): $(RUST_UPTIME_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_TRUNCATE_BLOB): $(RUST_TRUNCATE_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_STAT_BLOB): $(RUST_STAT_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(RUST_TTY_BLOB): $(RUST_TTY_BIN) | $(OBJ_DIR)/kernel/blobs
	@echo "OBJCOPY $@"
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
$(ARM64_WL_SETTINGS_BIN): arm64-libfutura
	@echo "Building ARM64 wl-settings..."
	@$(MAKE) -C src/user/clients/wl-settings PLATFORM=arm64 all
...
$(ARM64_RUST_UNAME_BIN): arm64-libfutura
	@echo "Building ARM64 rust-uname..."
	@$(MAKE) -C src/user/rust-uname PLATFORM=arm64 all

$(ARM64_RUST_PWD_BIN): arm64-libfutura
	@echo "Building ARM64 rust-pwd..."
	@$(MAKE) -C src/user/rust-pwd PLATFORM=arm64 all
...
$(ARM64_RUST_TOUCH_BIN): arm64-libfutura
	@echo "Building ARM64 rust-touch..."
	@$(MAKE) -C src/user/rust-touch PLATFORM=arm64 all
...
$(ARM64_RUST_TRUE_BIN): arm64-libfutura
	@echo "Building ARM64 rust-true..."
	@$(MAKE) -C src/user/rust-true PLATFORM=arm64 all

$(ARM64_RUST_FALSE_BIN): arm64-libfutura
	@echo "Building ARM64 rust-false..."
	@$(MAKE) -C src/user/rust-false PLATFORM=arm64 all

$(ARM64_RUST_ENV_BIN): arm64-libfutura
	@echo "Building ARM64 rust-env..."
	@$(MAKE) -C src/user/rust-env PLATFORM=arm64 all

$(ARM64_RUST_HEAD_BIN): arm64-libfutura
	@echo "Building ARM64 rust-head..."
	@$(MAKE) -C src/user/rust-head PLATFORM=arm64 all

$(ARM64_RUST_TAIL_BIN): arm64-libfutura
	@echo "Building ARM64 rust-tail..."
	@$(MAKE) -C src/user/rust-tail PLATFORM=arm64 all

$(ARM64_RUST_GREP_BIN): arm64-libfutura
	@echo "Building ARM64 rust-grep..."
	@$(MAKE) -C src/user/rust-grep PLATFORM=arm64 all
...
$(ARM64_RUST_TREE_BIN): arm64-libfutura
	@echo "Building ARM64 rust-tree..."
	@$(MAKE) -C src/user/rust-tree PLATFORM=arm64 all

$(ARM64_RUST_WALLPAPER_BIN): arm64-libfutura
	@echo "Building ARM64 rust-wallpaper..."
	@$(MAKE) -C src/user/rust-wallpaper PLATFORM=arm64 all

$(ARM64_RUST_CP_BIN): arm64-libfutura
	@echo "Building ARM64 rust-cp..."
	@$(MAKE) -C src/user/rust-cp PLATFORM=arm64 all

$(ARM64_RUST_MV_BIN): arm64-libfutura
	@echo "Building ARM64 rust-mv..."
	@$(MAKE) -C src/user/rust-mv PLATFORM=arm64 all

$(ARM64_RUST_BASENAME_BIN): arm64-libfutura
	@echo "Building ARM64 rust-basename..."
	@$(MAKE) -C src/user/rust-basename PLATFORM=arm64 all
...
$(ARM64_RUST_WHICH_BIN): arm64-libfutura
	@echo "Building ARM64 rust-which..."
	@$(MAKE) -C src/user/rust-which PLATFORM=arm64 all

$(ARM64_RUST_READLINK_BIN): arm64-libfutura
	@echo "Building ARM64 rust-readlink..."
	@$(MAKE) -C src/user/rust-readlink PLATFORM=arm64 all

$(ARM64_RUST_LN_BIN): arm64-libfutura
	@echo "Building ARM64 rust-ln..."
	@$(MAKE) -C src/user/rust-ln PLATFORM=arm64 all

$(ARM64_RUST_TEE_BIN): arm64-libfutura
	@echo "Building ARM64 rust-tee..."
	@$(MAKE) -C src/user/rust-tee PLATFORM=arm64 all

$(ARM64_RUST_YES_BIN): arm64-libfutura
	@echo "Building ARM64 rust-yes..."
	@$(MAKE) -C src/user/rust-yes PLATFORM=arm64 all

$(ARM64_RUST_UNIQ_BIN): arm64-libfutura
	@echo "Building ARM64 rust-uniq..."
	@$(MAKE) -C src/user/rust-uniq PLATFORM=arm64 all

$(ARM64_RUST_REALPATH_BIN): arm64-libfutura
	@echo "Building ARM64 rust-realpath..."
	@$(MAKE) -C src/user/rust-realpath PLATFORM=arm64 all

$(ARM64_RUST_CMP_BIN): arm64-libfutura
	@echo "Building ARM64 rust-cmp..."
	@$(MAKE) -C src/user/rust-cmp PLATFORM=arm64 all

$(ARM64_RUST_NL_BIN): arm64-libfutura
	@echo "Building ARM64 rust-nl..."
	@$(MAKE) -C src/user/rust-nl PLATFORM=arm64 all

$(ARM64_RUST_REV_BIN): arm64-libfutura
	@echo "Building ARM64 rust-rev..."
	@$(MAKE) -C src/user/rust-rev PLATFORM=arm64 all

$(ARM64_RUST_OD_BIN): arm64-libfutura
	@echo "Building ARM64 rust-od..."
	@$(MAKE) -C src/user/rust-od PLATFORM=arm64 all

$(ARM64_RUST_PRINTENV_BIN): arm64-libfutura
	@echo "Building ARM64 rust-printenv..."
	@$(MAKE) -C src/user/rust-printenv PLATFORM=arm64 all

$(ARM64_RUST_WHOAMI_BIN): arm64-libfutura
	@echo "Building ARM64 rust-whoami..."
	@$(MAKE) -C src/user/rust-whoami PLATFORM=arm64 all

$(ARM64_RUST_ID_BIN): arm64-libfutura
	@echo "Building ARM64 rust-id..."
	@$(MAKE) -C src/user/rust-id PLATFORM=arm64 all

$(ARM64_RUST_CHMOD_BIN): arm64-libfutura
	@echo "Building ARM64 rust-chmod..."
	@$(MAKE) -C src/user/rust-chmod PLATFORM=arm64 all

$(ARM64_RUST_HOSTNAME_BIN): arm64-libfutura
	@echo "Building ARM64 rust-hostname..."
	@$(MAKE) -C src/user/rust-hostname PLATFORM=arm64 all

$(ARM64_RUST_ARCH_BIN): arm64-libfutura
	@echo "Building ARM64 rust-arch..."
	@$(MAKE) -C src/user/rust-arch PLATFORM=arm64 all

$(ARM64_RUST_KILL_BIN): arm64-libfutura
	@echo "Building ARM64 rust-kill..."
	@$(MAKE) -C src/user/rust-kill PLATFORM=arm64 all

$(ARM64_RUST_RMDIR_BIN): arm64-libfutura
	@echo "Building ARM64 rust-rmdir..."
	@$(MAKE) -C src/user/rust-rmdir PLATFORM=arm64 all

$(ARM64_RUST_SYNC_BIN): arm64-libfutura
	@echo "Building ARM64 rust-sync..."
	@$(MAKE) -C src/user/rust-sync PLATFORM=arm64 all

$(ARM64_RUST_FOLD_BIN): arm64-libfutura
	@echo "Building ARM64 rust-fold..."
	@$(MAKE) -C src/user/rust-fold PLATFORM=arm64 all

$(ARM64_RUST_TAC_BIN): arm64-libfutura
	@echo "Building ARM64 rust-tac..."
	@$(MAKE) -C src/user/rust-tac PLATFORM=arm64 all

$(ARM64_RUST_STRINGS_BIN): arm64-libfutura
	@echo "Building ARM64 rust-strings..."
	@$(MAKE) -C src/user/rust-strings PLATFORM=arm64 all

$(ARM64_RUST_CUT_BIN): arm64-libfutura
	@echo "Building ARM64 rust-cut..."
	@$(MAKE) -C src/user/rust-cut PLATFORM=arm64 all

$(ARM64_RUST_SEQ_BIN): arm64-libfutura
	@echo "Building ARM64 rust-seq..."
	@$(MAKE) -C src/user/rust-seq PLATFORM=arm64 all

$(ARM64_RUST_TR_BIN): arm64-libfutura
	@echo "Building ARM64 rust-tr..."
	@$(MAKE) -C src/user/rust-tr PLATFORM=arm64 all

$(ARM64_RUST_BASE64_BIN): arm64-libfutura
	@echo "Building ARM64 rust-base64..."
	@$(MAKE) -C src/user/rust-base64 PLATFORM=arm64 all

$(ARM64_RUST_MKTEMP_BIN): arm64-libfutura
	@echo "Building ARM64 rust-mktemp..."
	@$(MAKE) -C src/user/rust-mktemp PLATFORM=arm64 all

$(ARM64_RUST_UPTIME_BIN): arm64-libfutura
	@echo "Building ARM64 rust-uptime..."
	@$(MAKE) -C src/user/rust-uptime PLATFORM=arm64 all

$(ARM64_RUST_TRUNCATE_BIN): arm64-libfutura
	@echo "Building ARM64 rust-truncate..."
	@$(MAKE) -C src/user/rust-truncate PLATFORM=arm64 all

$(ARM64_RUST_STAT_BIN): arm64-libfutura
	@echo "Building ARM64 rust-stat..."
	@$(MAKE) -C src/user/rust-stat PLATFORM=arm64 all

$(ARM64_RUST_TTY_BIN): arm64-libfutura
	@echo "Building ARM64 rust-tty..."
	@$(MAKE) -C src/user/rust-tty PLATFORM=arm64 all
endif
...
$(ARM64_WL_SETTINGS_BLOB): $(ARM64_WL_SETTINGS_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
$(ARM64_RUST_UNAME_BLOB): $(ARM64_RUST_UNAME_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_PWD_BLOB): $(ARM64_RUST_PWD_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
$(ARM64_RUST_TOUCH_BLOB): $(ARM64_RUST_TOUCH_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
$(ARM64_RUST_TRUE_BLOB): $(ARM64_RUST_TRUE_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_FALSE_BLOB): $(ARM64_RUST_FALSE_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_ENV_BLOB): $(ARM64_RUST_ENV_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_HEAD_BLOB): $(ARM64_RUST_HEAD_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_TAIL_BLOB): $(ARM64_RUST_TAIL_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_GREP_BLOB): $(ARM64_RUST_GREP_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
$(ARM64_RUST_TREE_BLOB): $(ARM64_RUST_TREE_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_WALLPAPER_BLOB): $(ARM64_RUST_WALLPAPER_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_CP_BLOB): $(ARM64_RUST_CP_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_MV_BLOB): $(ARM64_RUST_MV_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_BASENAME_BLOB): $(ARM64_RUST_BASENAME_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
$(ARM64_RUST_WHICH_BLOB): $(ARM64_RUST_WHICH_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_READLINK_BLOB): $(ARM64_RUST_READLINK_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_LN_BLOB): $(ARM64_RUST_LN_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_TEE_BLOB): $(ARM64_RUST_TEE_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_YES_BLOB): $(ARM64_RUST_YES_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_UNIQ_BLOB): $(ARM64_RUST_UNIQ_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_REALPATH_BLOB): $(ARM64_RUST_REALPATH_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_CMP_BLOB): $(ARM64_RUST_CMP_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_NL_BLOB): $(ARM64_RUST_NL_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_REV_BLOB): $(ARM64_RUST_REV_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_OD_BLOB): $(ARM64_RUST_OD_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_PRINTENV_BLOB): $(ARM64_RUST_PRINTENV_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_WHOAMI_BLOB): $(ARM64_RUST_WHOAMI_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_ID_BLOB): $(ARM64_RUST_ID_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_CHMOD_BLOB): $(ARM64_RUST_CHMOD_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_HOSTNAME_BLOB): $(ARM64_RUST_HOSTNAME_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_ARCH_BLOB): $(ARM64_RUST_ARCH_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_KILL_BLOB): $(ARM64_RUST_KILL_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_RMDIR_BLOB): $(ARM64_RUST_RMDIR_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_SYNC_BLOB): $(ARM64_RUST_SYNC_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_FOLD_BLOB): $(ARM64_RUST_FOLD_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_TAC_BLOB): $(ARM64_RUST_TAC_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_STRINGS_BLOB): $(ARM64_RUST_STRINGS_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_CUT_BLOB): $(ARM64_RUST_CUT_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_SEQ_BLOB): $(ARM64_RUST_SEQ_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_TR_BLOB): $(ARM64_RUST_TR_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_BASE64_BLOB): $(ARM64_RUST_BASE64_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_MKTEMP_BLOB): $(ARM64_RUST_MKTEMP_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_UPTIME_BLOB): $(ARM64_RUST_UPTIME_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_TRUNCATE_BLOB): $(ARM64_RUST_TRUNCATE_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_STAT_BLOB): $(ARM64_RUST_STAT_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@

$(ARM64_RUST_TTY_BLOB): $(ARM64_RUST_TTY_BIN) | $(OBJ_DIR)/kernel/blobs
	@$(OBJCOPY) --strip-debug $< $<.tmp && mv $<.tmp $<
	@$(OBJCOPY) -I binary -O $(OBJCOPY_BIN_FMT) -B $(OBJCOPY_BIN_ARCH) $< $@
...
help:
	...
	@echo "  wayland-step2      - Boot Wayland compositor + first-party client (scenario test)"
	@echo "  wayland-step3      - Boot Wayland compositor with two concurrent clients (scenario test)"
