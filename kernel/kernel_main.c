...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1944u; /* misc(1944): ..., splice_o_append (1592-1593), sendfile_o_append (1594-1595), openat_o_directory (1596-1597), dup2_newfd_range (1598-1599), wait_flags (1600-1603), setgroups_cap (1604), setreuid_saved (1605-1613), cred_dumpable (1614-1619), setpgid_exec (1620), cap_uid_transitions (1621-1624), sigpending_mask (1625-1626), priority_neg_who (1627-1628), faccessat_eaccess (1629-1630), wnowait_stopped_cont (1631-1632), mremap_vma_boundary (1633), futex_bitset_zero (1634-1635), epoll_maxevents_cap_hup (1636-1638), mprotect_gap (1639), signalfd_fields (1640), rusage_children_nvcsw (1641), brk_rlimit_as (1642), rusage_minflt (1643), wait4_rusage (1644), vmpeak_tracking (1645), oom_score_adj (1646), procfs_io_bytes (1647), fork_cwd (1648), fork_affinity (1649), fork_cmdline (1650), fork_sigaltstack (1651), async_sigio (1652), async_f_setsig (1653), async_socket (1654), async_pipe_write_end (1655), async_socket_recv (1656), f_setown_ex (1657), f_setown_ex_pgrp (1658), rseq_tracking (1659), rseq_cpu_id (1660), fgetfl_mask (1661), fgetfl_status (1662), fioasync_set (1663), fioasync_clear (1664), pty_open_ptmx (1665), pty_tiocgptn (1666), pty_open_slave (1667), pty_master_to_slave (1668), pty_slave_to_master (1669), pty_winsize (1670), pty_fionread (1671), pty_master_close_eof (1672), pty_tcsets_independence (1673), pty_tcgets_per_pair (1674), pty_winsize_independence (1675), pty_tcsets_master_slave (1676), pty_poll_writable (1677), pty_poll_readable (1678), pty_select_readable (1679), pty_epoll_readable (1680), pty_readlink_master (1681), pty_readlink_slave (1682), pty_tty_nr (1683), pty_tty_nr_persist (1684), auxv_hwcap_nonzero (1685), auxv_clktck (1686), auxv_pagesz (1687), auxv_hwcap_fpu_sse2 (1688), pts_dir_empty (1689), pts_dir_has_slave (1690), pts_dir_removed (1691), pts_dir_two_slaves (1692), pty_refcount_double_open (1693), pty_refcount_first_close (1694), pty_refcount_last_close_eof (1695), pty_refcount_dir_persist (1696), pie_at_entry (1697), pie_at_phdr (1698), pie_entry_range (1699), pie_pagesz (1700), pty_sigwinch_master (1701), pty_sigwinch_slave (1702), pty_winsize_readback (1703), pty_sigwinch_sigign (1704), auxv_at_base (1705), auxv_at_flags (1706), status_ngid (1707), auxv_entry_count (1708), maps_stack (1709), stack_rw_p (1710), maps_heap (1711), maps_code_rxp (1712), exec_enoent (1713), exec_empty (1714), exec_bad_magic (1715), shebang_enoent (1716), chdir_getcwd_roundtrip (1717), chdir_dotdot (1718), fchdir_dirfd (1719), chdir_nested (1720), timer_abstime_past (1721), nanosleep_abstime_past (1722), nanosleep_bad_clock (1723), nanosleep_bad_nsec (1724), exec_empty_enoexec (1725), exec_bad_magic (1726), exec_handler_preserved (1727), exec_dir_error (1728), umask_file_022 (1729), umask_file_077 (1730), umask_000 (1731), umask_mkdir (1732), umask_create_file (1733), umask_openat (1734), umask_mount_point (1735), umask_return_old (1736), close_neg1 (1737), double_close (1738), read_closed (1739), dup_closed (1740), rename_write_persist (1741), rename_old_gone (1742), unlink_fd_works (1743), unlink_stat_enoent (1744), fork_tty_nr (1745), tty_nr_current (1746), fork_pgid (1747), fork_seccomp (1748), tiocnotty_clear (1749), tiocsctty_set (1750), ctty_roundtrip (1751), tiocgsid (1752), setsid_clears_tty (1753), setsid_sid_eq_pid (1754), setsid_pgid_eq_pid (1755), setsid_eperm (1756), td_chr_release (1757), td_pts_cleanup (1758), td_reg_refcount (1759), td_empty_fds (1760), sighup_leader_exit (1761), no_sighup_nonleader (1762), no_sighup_no_ctty (1763), sighup_default_term (1764), daemon_setsid_chdir (1765), daemon_devnull_stdin (1766), devnull_write (1767), devzero_read (1768), fdinfo_regular (1769), fdinfo_ptmx (1770), fdinfo_pipe (1771), fdinfo_dir (1772), pty_cc_vintr (1773), pty_cc_veof (1774), pty_cc_verase (1775), pty_cc_vsusp (1776), dev_tty_pty_read (1777), dev_tty_write (1778), dev_tty_redirected (1779), dev_tty_no_ctty (1780), isatty_pty_slave (1781), isatty_pty_master (1782), isatty_devnull (1783), isatty_pipe (1784), pty_fgetfl (1785), pty_fsetfl_nonblock (1786), pty_nonblock_eagain (1787), pty_fdupfd (1788), cloexec_ptmx (1789), cloexec_devnull (1790), no_cloexec_ptmx (1791), cloexec_urandom (1792), pts_slave_cloexec (1793), pts_slave_no_cloexec (1794), dev_tty_cloexec (1795), dev_tty_no_cloexec (1796), netif_lo_exists (1797), route_loopback (1798), netif_eth0_default (1799), route_lpm (1800), fw_default_accept (1801), fw_drop_rule (1802), fw_nonmatch_pass (1803), fw_flush (1804), ioctl_siocsifaddr (1805), ioctl_siocsifnetmask (1806), ioctl_siocaddrt (1807), ioctl_siocdelrt (1808), arp_proc_entry (1809), ip_fwd_ttl_expired (1810), ip_fwd_no_route (1811), ip_fwd_disabled (1812), bindtodevice_lo (1813), bindtodevice_nodev (1814), bindtodevice_unbind (1815), ifconf_multi (1816), hwaddr_eth0 (1817), ifindex_eth0 (1818), ifname_lo (1819), siocsifmtu (1820), nf_conntrack (1821), snmp_stats (1822), sysctl_somaxconn (1823), sysctl_fin_timeout (1824), sysctl_ip_forward (1825), sysctl_port_start (1826), sysctl_ttl (1827), tun_open (1828), mknod_chrdev (1829), mknod_blkdev_eperm (1830), fw_ioctl_add (1831), fw_ioctl_policy (1832), fw_ioctl_flush (1833), fw_ioctl_einval (1834), fib_trie_routes (1835), sockstat (1836), siocsifhwaddr (1837), masq_dev_sysctl (1838), sysfs_net_mtu (1839), tcp_listen_state (1840), dev_kmsg (1841), proc_modules (1842), kmsg_write (1843), router_config (1844), ip_forward_sysctl (1845), uptime_format (1846), dns_cache_add (1847), dns_cache_miss (1848), tun_create (1849), nat_masquerade (1850), snmp_ttl_stats (1851), router_integration (1852), ip_ttl_sockopt (1853), ip_tos_sockopt (1854), futurafs_write (1855), futurafs_read (1856), futurafs_unlink (1857), diskstats_ramdisk (1858), partitions_ramdisk (1859), pci_devices (1860), vlan_create (1861), vlan_in_procnet (1862), vlan_dup_eexist (1863), vlan_id0_einval (1864), bridge_create (1865), bridge_addif (1866), bridge_dup_eexist (1867), bridge_in_procnet (1868), conf_lo_fwd (1869), conf_eth0_rpfilter (1870), conf_noent (1871), gre_create (1872), gre_in_procnet (1873), gre_dup_eexist (1874), if_inet6_loopback (1875), fork_rlimit_as_tiny (1876), fork_rlimit_as_inf (1877), rule_add (1878), rule_dup_eexist (1879), rule_del (1880), rule_lookup_default (1881), timerfd_abstime_underflow (1882), timer_abstime_underflow (1883), route_add_table_lookup (1884), loop_open (1885), loop_set_fd (1886), loop_diskstats (1887), watchdog_open (1888), watchdog_feed (1889), watchdog_timeleft (1890), nf_conntrack_max (1891), mseal_noop (1892), mseal_bad_flags (1893), fchmodat2_perm (1894), kcmp_vm (1895), kcmp_files (1896), kcmp_sighand (1897), hwrng_read (1898), console_open (1899), hwrng_nonrepeat (1900), futurafs_mkdir (1901), futurafs_subdir (1902), futurafs_stat (1903), futurafs_ftruncate (1904), futurafs_rename (1905), futurafs_cleanup (1906), etc_services (1907), etc_protocols (1908), etc_shadow (1909), futurafs_append (1910), futurafs_flock (1911), futurafs_lseek (1912), file_nr_count (1913), io_rchar (1914), io_wchar (1915), dir_bin (1916), dir_usr_bin (1917), dir_root (1918), dir_var_log (1919), mounts_tmpfs (1920), psi_cpu (1921), psi_memory (1922), futurafs_hardlink (1923), futurafs_symlink (1924), futurafs_nlinks (1925), futurafs_otrunc (1926), futurafs_oexcl (1927), futurafs_concurrent (1928), futurafs_readdir (1929), sched_child_first (1930), futurafs_statfs (1931), futurafs_namelen (1932), sys_class_block (1933), sysfs_pci_devices (1934), tc_qdisc_add (1935), ipsec_sa_add (1936), ipsec_sa_dup (1937), ipv6_tcp (1938), ipv6_udp (1939), xfrm_stat (1940), bin_shell_exists (1941), bin_shell_elf (1942), ipv6_route (1943), ext2_driver (1944) */
    ...
    */
    ...
    }
    {
        ...
        ext2_init();  /* ext2 filesystem driver */
    }
    {
