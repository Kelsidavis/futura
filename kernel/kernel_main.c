...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1574u; /* misc(1574): ..., seqpacket_msg_eor (1565-1566), dgram_boundaries (1567-1568), dgram_trunc (1569-1570), recv_trunc_flag (1571-1572), peek_trunc_size (1573-1574) */
