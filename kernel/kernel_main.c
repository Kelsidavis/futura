...
#define ETC_WRITE(path, content) do { \
    ...
    if (_fd >= 0) { \
        ...
        ETC_WRITE("/etc/motd",
                  ...
                  "\n"
                  "  * 118 built-in commands — type 'help'\n"
