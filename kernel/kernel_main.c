...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1561u; /* misc(1561): ..., so_linger (1543-1546), socketpair_nonblock (1547-1548), so_protocol_domain_acceptconn (1549-1554), tiocoutq (1555-1557), so_rcvlowat (1558-1561) */
