...
- Rust driver integration (staticlib compilation) — **78 crates** across x86-64 (48 drivers incl. NVMe, AHCI, xHCI, USB HID/Storage/Hub/CDC-ECM/Audio, RTL8111/I225-V/I211/XGBE, HDA+Realtek, LAPIC/IOAPIC, UART 16550, i8042, PCIe ECAM/AER/SR-IOV, Eth PHY, EDID, DMA pool, FB console, AMD DF/NBIO/PSP/SMN/UMC/CCP/I2C/SMBus/IOMMU/GPIO/WDT/SPI/SB-TSI/P-State, ACPI PM/EC/Thermal, x86 MCE, VESA FB, HPET, RTC, TPM 2.0, PCI MSI-X/PM), ARM64, and VirtIO.
