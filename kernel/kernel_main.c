...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1316u; /* misc(1316): ..., mount API stubs (1297-1305), clone3 CLEAR_SIGHAND (1306-1308), proc speculation (1309-1310), exit_signal (1311-1313), CLONE_PARENT (1314-1316) */
