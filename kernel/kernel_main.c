...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1957u; /* misc(1957): ..., io_uring_setup (1946), io_uring_params (1947), io_uring_nop (1948), io_uring_read (1949), io_uring_write (1950), io_uring_close (1951), io_uring_fsync (1952), io_uring_invalid_op (1953), io_uring_user_data (1954), io_uring_probe (1955), io_uring_reg_files (1956), io_uring_zero_entries (1957) */
