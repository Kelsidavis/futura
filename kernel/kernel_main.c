...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 305u; /* misc(305): +seek_data_hole(293-296),getsockopt_ext(297-299),waitid_p_pidfd(300),rlimit_cpu(301),mq_notify(302),rseq(303),close_range(304),seqpacket(305) */
