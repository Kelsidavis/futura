...
static volatile struct virtio_desc *g_desc_table_arm = NULL;
static volatile struct virtio_avail *g_avail_arm = NULL;
static volatile struct virtio_used *g_used_arm = NULL;
