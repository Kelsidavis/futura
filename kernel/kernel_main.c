...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1587u; /* misc(1587): ..., recv_trunc_flag (1571-1572), peek_trunc_size (1573-1574), seqpacket_waitall (1575-1576), fionread_dgram (1577-1578), shutdown_eof (1579-1580), epoll_rdhup (1581-1584), map_shared_procfs (1585-1587) */
