...
struct fut_file {
    ...
    int owner_type;                 /* Owner type: F_OWNER_TID(0), F_OWNER_PID(1), F_OWNER_PGRP(2) */
...
/* Resolve fd -> file AND take a reference atomically against a
 * concurrent close() (SMP-safe; closes the use-after-free window in a
