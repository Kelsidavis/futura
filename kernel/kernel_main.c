...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1282u; /* misc(1282): ..., openat2 RESOLVE_BENEATH (1270-1272), capget version/pid/2-struct (1273-1275), capset version/2-struct/validation (1276-1279), WCOREDUMP bit (1280-1282) */
