...
- **Platforms**: x86-64 is the reference build; ARM64 port with **Raspberry Pi 4/5** and Apple Silicon support. **72 Rust driver crates**: x86-64 AMD Ryzen AM4/AM5 (**42 drivers**: NVMe, AHCI SATA, xHCI USB 3.x, USB HID, USB Mass Storage, RTL8111 GbE, Intel I225-V 2.5GbE, Intel I211 GbE, HD Audio, LAPIC/IOAPIC, UART 16550, i8042 PS/2, PCIe ECAM, AMD SMBus, AMD IOMMU, AMD GPIO, AMD Watchdog, AMD SPI Flash, AMD SB-TSI temp, AMD P-State/CPPC, HPET, CMOS RTC, TPM 2.0 CRB, PCI MSI-X, AMD SMN, AMD UMC, AMD CCP crypto, ACPI PM, VESA framebuffer, PCI PM, AMD Data Fabric, AMD NBIO, AMD I2C, USB CDC/ECM net, USB Hub, USB Audio, HDA Realtek codec, AMD PSP, x86 MCE, PCIe AER, ACPI EC, Ethernet PHY), RPi (**16 drivers**: mailbox, eMMC2/SDHCI, GPIO, GENET Ethernet, HDMI display, USB xHCI, watchdog, I2C, SPI, PWM, HW RNG, DMA, PCIe, audio, thermal/DVFS, camera), Apple Silicon (AIC, UART, RTKit, ANS2, GPIO, I2C, PCIe, SPI, DART, SMC, MCA), VirtIO (blk, gpu, input, net). RPi4/5 boot entry with EL drop, DTB detection, PL011 UART, GIC-400; complete BCM2711/BCM2712 peripheral maps; SD card config.txt generation via `make rpi-image`.
