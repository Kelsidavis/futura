...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1291u; /* misc(1291): ..., openat2 RESOLVE_BENEATH (1270-1272), capget version/pid/2-struct (1273-1275), capset version/2-struct/validation (1276-1279), WCOREDUMP bit (1280-1282), waitid CLD_DUMPED (1283-1284), futex_waitv basic (1285-1291) */
