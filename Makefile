...
ifneq ($(shell uname -s),Darwin)
OBJECTS += $(WAYLAND_COMPOSITOR_BLOB) $(WAYLAND_SHELL_BLOB) $(WL_TERM_BLOB) $(WL_PANEL_BLOB) $(WL_EDIT_BLOB) $(WL_SYSMON_BLOB) $(WL_SETTINGS_BLOB) $(WL_FILES_BLOB) $(WL_WALLPAPER_BLOB) $(RUST_HELLO_BLOB) $(RUST_UNAME_BLOB)
...
ifeq ($(ENABLE_WAYLAND),1)
OBJECTS += $(ARM64_WAYLAND_COMPOSITOR_BLOB) $(ARM64_WAYLAND_SHELL_BLOB) $(ARM64_WL_TERM_BLOB) $(ARM64_WL_PANEL_BLOB) $(ARM64_WL_EDIT_BLOB) $(ARM64_WL_SYSMON_BLOB) $(ARM64_WL_SETTINGS_BLOB) $(ARM64_WL_FILES_BLOB) $(ARM64_WL_WALLPAPER_BLOB) $(ARM64_RUST_HELLO_BLOB) $(ARM64_RUST_UNAME_BLOB)
endif
endif
