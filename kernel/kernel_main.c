...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 367u; /* misc(367): +wchan(360), mountinfo(361), coredump_filter(362), proc_sys_hostname_write(363), schedstat(364), core_pattern(365), core_uses_pid(366), proc_pid_net_unix(367) */
