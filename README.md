...
### Status Snapshot — v0.7.0 (Mar 28 2026)

- **Kernel core**: 400+ Linux-compatible syscalls across 230+ implementation files, 230K+ lines of kernel C. Priority-aware scheduler (nice + RT), PI futex, per-task MMU contexts, COW fork, file-backed mmap, ELF loader with PT_INTERP, kernel_oops() framework, pivot_root(), real TCP state machine.
- **Testing**: **2369+ automated kernel self-tests** across 11 test groups, all passing. CI: GitHub Actions with x86_64 + ARM64 QEMU test runners, consistently green.
