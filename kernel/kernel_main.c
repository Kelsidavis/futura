...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1100u; /* misc(1100): ..., inotify_self_events (1080-1082), mremap_dontunmap+fdinfo (1083-1088), fd_anon_symlinks (1089-1092), fdinfo_pos_flags (1093-1096), sa_restart_sigblk (1097-1100) */
