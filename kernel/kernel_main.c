...
#define ETC_WRITE(path, content) do { \
    ...
    if (_fd >= 0) { \
        ...
        ETC_WRITE("/etc/motd",
                  ...
                  "\n"
                  "  * 105 built-in commands — type 'help'\n"
