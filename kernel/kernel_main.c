...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1487u; /* misc(1487): ..., resolve_no_symlinks (1475-1477), setfl_o_direct (1478), resolve_in_root (1479-1481), sendfile_socket (1482), cfr_pipe (1483), socket_atomic_flags (1484-1487) */
