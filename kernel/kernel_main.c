...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1114u; /* misc(1114): ..., fdinfo_pos_flags (1093-1096), sa_restart_sigblk (1097-1100), sched_batch_idle (1101-1104), sched_rt_policy (1105-1110), sched_param_rt (1111-1114) */
