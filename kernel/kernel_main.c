...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1664u; /* misc(1664): ..., splice_o_append (1592-1593), sendfile_o_append (1594-1595), openat_o_directory (1596-1597), dup2_newfd_range (1598-1599), wait_flags (1600-1603), setgroups_cap (1604), setreuid_saved (1605-1613), cred_dumpable (1614-1619), setpgid_exec (1620), cap_uid_transitions (1621-1624), sigpending_mask (1625-1626), priority_neg_who (1627-1628), faccessat_eaccess (1629-1630), wnowait_stopped_cont (1631-1632), mremap_vma_boundary (1633), futex_bitset_zero (1634-1635), epoll_maxevents_cap_hup (1636-1638), mprotect_gap (1639), signalfd_fields (1640), rusage_children_nvcsw (1641), brk_rlimit_as (1642), rusage_minflt (1643), wait4_rusage (1644), vmpeak_tracking (1645), oom_score_adj (1646), procfs_io_bytes (1647), fork_cwd (1648), fork_affinity (1649), fork_cmdline (1650), fork_sigaltstack (1651), async_sigio (1652), async_f_setsig (1653), async_socket (1654), async_pipe_write_end (1655), async_socket_recv (1656), f_setown_ex (1657), f_setown_ex_pgrp (1658), rseq_tracking (1659), rseq_cpu_id (1660), fgetfl_mask (1661), fgetfl_status (1662), fioasync_set (1663), fioasync_clear (1664) */
