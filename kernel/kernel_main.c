...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1969u; /* misc(1969): ..., io_uring (1946-1957), keyring_add (1958), keyring_read (1959), keyring_describe (1960), keyring_update (1961), keyring_request (1962), keyring_enokey (1963), keyring_revoke (1964), keyring_badtype (1965), keyring_subring (1966), keyring_search (1967), keyring_setperm (1968), keyring_invalidate (1969) */
