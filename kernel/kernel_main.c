...
#define ETC_WRITE(path, content) do { \
    ...
    if (_fd >= 0) { \
        ...
        ETC_WRITE("/etc/motd",
                  ...
                  "  Futura OS 0.6.0\n"
                  "\n"
                  "  195 built-in commands — type 'help' or 'man <cmd>'\n"
                  "\n"
...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 2266u; /* misc(2266): ..., memfd_seal+pidfd+close_range+dup (2240-2259), socket_opt_enforcement (2270-2272), pty_winsize_ctty (2285-2288) */
