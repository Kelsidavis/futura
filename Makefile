...
RUST_X86_PLATFORM_LIBS := $(RUST_LIB_X86_CPUID) $(RUST_LIB_X86_TSC) $(RUST_LIB_HPET) $(RUST_LIB_CMOS_RTC) $(RUST_LIB_UART16550) $(RUST_LIB_I8042) $(RUST_LIB_PCIE_ECAM) $(RUST_LIB_PCI_MSIX) $(RUST_LIB_LAPIC) $(RUST_LIB_DMA_POOL) $(RUST_LIB_PCI_PM) $(RUST_LIB_VESA_FB) $(RUST_LIB_FB_CONSOLE) $(RUST_LIB_EDID) $(RUST_LIB_ACPI_PM) $(RUST_LIB_ACPI_EC) $(RUST_LIB_CROS_EC) $(RUST_LIB_ACPI_BTN) $(RUST_LIB_ACPI_THERMAL) $(RUST_LIB_PCI_AER) $(RUST_LIB_PCI_SRIOV) $(RUST_LIB_ETH_PHY) $(RUST_LIB_TPM_CRB) $(RUST_LIB_X86_MCE)

# Storage + USB + Audio (common across vendors)
RUST_X86_STORAGE_LIBS := $(RUST_LIB_NVME) $(RUST_LIB_AHCI) $(RUST_LIB_XHCI) $(RUST_LIB_USB_HID) $(RUST_LIB_USB_STORAGE) $(RUST_LIB_USB_NET) $(RUST_LIB_USB_HUB) $(RUST_LIB_USB_AUDIO) $(RUST_LIB_USB_BT) $(RUST_LIB_HDA) $(RUST_LIB_HDA_REALTEK) $(RUST_LIB_SDHCI) $(RUST_LIB_INTEL_PINCTRL)
