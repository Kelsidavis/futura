...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1638u; /* misc(1638): ..., splice_o_append (1592-1593), sendfile_o_append (1594-1595), openat_o_directory (1596-1597), dup2_newfd_range (1598-1599), wait_flags (1600-1603), setgroups_cap (1604), setreuid_saved (1605-1613), cred_dumpable (1614-1619), setpgid_exec (1620), cap_uid_transitions (1621-1624), sigpending_mask (1625-1626), priority_neg_who (1627-1628), faccessat_eaccess (1629-1630), wnowait_stopped_cont (1631-1632), mremap_vma_boundary (1633), futex_bitset_zero (1634-1635), epoll_maxevents_cap_hup (1636-1638) */
