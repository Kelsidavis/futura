...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1498u; /* misc(1498): ..., socket_atomic_flags (1484-1487), pipe2_atomic_flags (1488-1489), open_creat_directory (1490-1492), poll_neg_timeout (1493), fcntl_dupfd_rlimit (1494-1495), socketpair_invalid_flags (1496), so_rcvbuf_cap (1497-1498) */
