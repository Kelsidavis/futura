...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 2001u; /* misc(2001): ..., io_uring (1946-1957), keyring (1958-1969), modern_mount_api (1970-1975), fanotify (1976-1981), userfaultfd_statmount (1982-1993), perf_events (1994-2001) */
