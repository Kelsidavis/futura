...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1620u; /* misc(1620): ..., splice_o_append (1592-1593), sendfile_o_append (1594-1595), openat_o_directory (1596-1597), dup2_newfd_range (1598-1599), wait_flags (1600-1603), setgroups_cap (1604), setreuid_saved (1605-1613), cred_dumpable (1614-1619), setpgid_exec (1620) */
