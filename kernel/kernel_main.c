...
#undef ETC_WRITE
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 1522u; /* misc(1522): ..., prctl_dumpable_root (1505), af_inet_tcp (1506-1510), af_inet_udp (1511-1513), connect_refused (1514), bind_conflict (1515-1516), af_inet_extended (1517-1522) */
