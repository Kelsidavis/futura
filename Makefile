...
RUST_X86_STORAGE_LIBS := $(RUST_LIB_NVME) $(RUST_LIB_AHCI) $(RUST_LIB_XHCI) $(RUST_LIB_USB_HID) $(RUST_LIB_USB_STORAGE) $(RUST_LIB_USB_NET) $(RUST_LIB_USB_HUB) $(RUST_LIB_USB_AUDIO) $(RUST_LIB_HDA) $(RUST_LIB_HDA_REALTEK) $(RUST_LIB_SDHCI) $(RUST_LIB_INTEL_PINCTRL)
