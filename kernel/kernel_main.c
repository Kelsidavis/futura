...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 497u; /* misc(497): ..., sa_restorer(461), sa_onstack(465-467), thread-self(462-464), linux5.16-stubs(468-472), clone3(473-476), linux6.10-stubs(477-481), proc-mem(482-485), sigev-thread-id(486-488), subreaper-reparent(489-491), unshare-ns(492-497) */
