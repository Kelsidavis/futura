...
ifneq ($(shell uname -s),Darwin)
OBJECTS += $(RUST_HELLO_BLOB) $(RUST_UNAME_BLOB) $(RUST_PWD_BLOB) $(RUST_LS_BLOB) $(RUST_MKDIR_BLOB) $(RUST_TOUCH_BLOB) $(RUST_RM_BLOB) $(RUST_CAT_BLOB) $(RUST_WC_BLOB) $(RUST_TRUE_BLOB) $(RUST_FALSE_BLOB) $(RUST_ENV_BLOB) $(RUST_HEAD_BLOB) $(RUST_TAIL_BLOB) $(RUST_GREP_BLOB) $(RUST_SLEEP_BLOB) $(RUST_DATE_BLOB) $(RUST_SETTINGS_BLOB) $(RUST_TREE_BLOB) $(RUST_WALLPAPER_BLOB) $(RUST_CP_BLOB) $(RUST_MV_BLOB) $(RUST_BASENAME_BLOB) $(RUST_DIRNAME_BLOB) $(RUST_CLEAR_BLOB) $(RUST_WHICH_BLOB) $(RUST_READLINK_BLOB) $(RUST_LN_BLOB) $(RUST_TEE_BLOB) $(RUST_YES_BLOB) $(RUST_UNIQ_BLOB) $(RUST_REALPATH_BLOB) $(RUST_CMP_BLOB) $(RUST_NL_BLOB) $(RUST_REV_BLOB) $(RUST_OD_BLOB) $(RUST_PRINTENV_BLOB) $(RUST_WHOAMI_BLOB)
endif
endif
else ifeq ($(PLATFORM),arm64)
