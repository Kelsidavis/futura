...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 362u; /* misc(362): +SO_SNDBUF/RCVBUF(352,353), stat sigmask(354), maps format(355,356), status groups/umask(357,358), stat starttime(359), wchan(360), mountinfo(361), coredump_filter(362) */
