...
void fut_kernel_main(void) {
    ...
    if (run_async_selftests) {
        ...
        planned_tests += 316u; /* misc(316): +dgram_sendto(309),sendmmsg(310),futex_wait_bitset(311),dgram_connect(312),getsockname_abstract(313),circ_wrap(314),so_rcvtimeo(315),msg_waitall(316) */
