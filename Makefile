...
RUST_INTEL_LIBS := $(RUST_LIB_INTEL_VTD) $(RUST_LIB_INTEL_HWP) $(RUST_LIB_INTEL_LPSS) $(RUST_LIB_INTEL_PMC) $(RUST_LIB_INTEL_GPIO) $(RUST_LIB_INTEL_WDT) $(RUST_LIB_INTEL_MEI) $(RUST_LIB_INTEL_TBT) $(RUST_LIB_INTEL_THERM) $(RUST_LIB_INTEL_GNA) $(RUST_LIB_INTEL_SST) $(RUST_LIB_INTEL_HDMI) $(RUST_LIB_INTEL_CNVI) $(RUST_LIB_INTEL_DMA) $(RUST_LIB_INTEL_IPU) $(RUST_LIB_INTEL_P2SB) $(RUST_LIB_INTEL_SMBUS) $(RUST_LIB_INTEL_SPI) $(RUST_LIB_I915)
